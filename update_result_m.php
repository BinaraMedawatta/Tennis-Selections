...
<html>
	...
	<body class="is-preload">
      ...
      $sql = "SELECT DISTINCT Player_1 FROM match_formations";
      ...
      $sql = "SELECT DISTINCT Player_2 FROM match_formations";
      $result = $conn->query($sql);
   ...
   ?>
      ...
      <?php
      $sql = "SELECT Name FROM players WHERE Gender = 'Male'";
      $result = $conn->query($sql);
   ...
   ?>
      ...
      <?php
       ...
       if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $sql_u = "UPDATE match_formations SET P_1_Score = '$p_p_1', P_2_Score = '$p_p_2', Winner = '$winner' WHERE Player_1 = '$m_p_1' && Player_2 = '$m_p_2'";
