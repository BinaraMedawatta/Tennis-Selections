	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
         ...
         <?php
            ...
            $sql = "SELECT * FROM match_formations_w WHERE Winner IS NULL";
			...
			echo "<td><a href='update_result_w_via_yet.php?id=".$row['Match_ID']."'><button class='button primary small'>Edit</button></a></td>";
            echo "<tr>";
            }
            echo "</table>";
            }
