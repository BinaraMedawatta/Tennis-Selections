	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
         ...
         <?php
            ...
            // $sql = "SELECT Winner, COUNT(*) FROM match_formations WHERE Winner IS NOT Null GROUP BY Winner ORDER BY COUNT(*) DESC";
        	$sql = "SELECT Winner, COUNT(*) FROM match_formations WHERE Winner IS NOT Null GROUP BY Winner ORDER BY COUNT(*) DESC LIMIT 6";
            ...
            ?>
            <ul class="actions">
				<li><a href="view_all_m.php" class="button big">View All</a></li>
			</ul>
      </div>
         ...
         <?php
            //$myInput = $_GET["myInput"];
            $sql = "SELECT Winner, COUNT(*) FROM match_formations_w WHERE Winner IS NOT Null GROUP BY Winner ORDER BY COUNT(*) DESC LIMIT 6";
            // $sql = "SELECT * FROM match_formations WHERE Winner IS NULL";
            $result = $conn->query($sql);
            if($result->num_rows > 0){
            echo "<table>
            ...
            <ul class="actions">
				<li><a href="view_all_w.php" class="button big">View All</a></li>
			</ul>
      </div>
									</div>
